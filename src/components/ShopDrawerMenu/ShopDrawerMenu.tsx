...
interface ShopDrawerMenuProps {
  ...
  categories?: { label: string; value: string }[]; // Make categories optional
  materials?: { label: string; value: string }[]; // Make categories optional
}

const ShopDrawerMenu: React.FC<ShopDrawerMenuProps> = ({
  onFilterChange,
  categories,
  materials,
}) => {
